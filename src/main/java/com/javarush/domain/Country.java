...
public class Country {
    ...
    public String getGovernmertForm() {
        return governmertForm;
    }

    public void setGovernmertForm(String governmertForm) {
        this.governmertForm = governmertForm;
    }
